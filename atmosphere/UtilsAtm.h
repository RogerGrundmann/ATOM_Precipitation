...
//            int i_radial = m.im-1;
    ...
    void resetArrays()
    {
        ...
        Array* arrays_3d_zero[] = {
            ...
            &m.vbud_pgf, &m.vbud_cor, &m.vbud_advv, &m.vbud_advh, &m.vbud_diff, &m.vbud_other, &m.vbud_drag,
            &m.wbud_pgf, &m.wbud_cor, &m.wbud_advv, &m.wbud_advh, &m.wbud_diff, &m.wbud_other, &m.wbud_drag,
